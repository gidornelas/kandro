...
export function RegisterView({ onToggle }: RegisterViewProps) {
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
          ...
          <input
            ...
            style={{
              ...
              border: `1px solid ${fieldErrors.name ? 'var(--red)' : 'var(--b1)'}`,
              background: 'var(--bg)', color: 'var(--t1)', fontSize: 13,
              outline: 'none',
            }}
          />
          {fieldErrors.name && (
            <span style={{ fontSize: 11, color: 'var(--red)' }}>{fieldErrors.name}</span>
          )}
        </div>
