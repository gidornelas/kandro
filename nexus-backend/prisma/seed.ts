...
async function main() {
  ...
  await prisma.teamPermission.createMany({
    data: [
      { teamId: "design", resourceId: "design-reviews", resourceType: "channel", level: "edit" },
      { teamId: "design", resourceId: "dsv2", resourceType: "board", level: "edit" },
      { teamId: "design", resourceId: "onboarding", resourceType: "board", level: "edit" },
      { teamId: "design", resourceId: "design-assets", resourceType: "folder", level: "edit" },
      { teamId: "design", resourceId: "brand-guide", resourceType: "folder", level: "edit" },
      { teamId: "produto", resourceId: "releases", resourceType: "channel", level: "edit" },
      { teamId: "produto", resourceId: "sprint12", resourceType: "board", level: "edit" },
      { teamId: "produto", resourceId: "dsv2", resourceType: "board", level: "edit" },
      { teamId: "produto", resourceId: "onboarding", resourceType: "board", level: "edit" },
      { teamId: "produto", resourceId: "research", resourceType: "folder", level: "edit" },
      { teamId: "dev", resourceId: "releases", resourceType: "channel", level: "edit" },
      { teamId: "dev", resourceId: "sprint12", resourceType: "board", level: "edit" },
      { teamId: "dev", resourceId: "specs-tecnicas", resourceType: "folder", level: "edit" },
      { teamId: "marketing", resourceId: "campanhas", resourceType: "folder", level: "edit" },
      { teamId: "marketing", resourceId: "brand-guide", resourceType: "folder", level: "view" },
      { teamId: "lideranca", resourceId: "geral", resourceType: "channel", level: "edit" },
      { teamId: "lideranca", resourceId: "design-reviews", resourceType: "channel", level: "edit" },
      { teamId: "lideranca", resourceId: "releases", resourceType: "channel", level: "edit" },
      { teamId: "lideranca", resourceId: "admin-ops", resourceType: "channel", level: "edit" },
      { teamId: "lideranca", resourceId: "sprint12", resourceType: "board", level: "edit" },
      { teamId: "lideranca", resourceId: "dsv2", resourceType: "board", level: "edit" },
      { teamId: "lideranca", resourceId: "onboarding", resourceType: "board", level: "edit" },
      { teamId: "lideranca", resourceId: "design-assets", resourceType: "folder", level: "edit" },
      { teamId: "lideranca", resourceId: "brand-guide", resourceType: "folder", level: "edit" },
      { teamId: "lideranca", resourceId: "research", resourceType: "folder", level: "edit" },
      { teamId: "lideranca", resourceId: "campanhas", resourceType: "folder", level: "edit" },
      { teamId: "lideranca", resourceId: "specs-tecnicas", resourceType: "folder", level: "edit" },
    ],
  });
